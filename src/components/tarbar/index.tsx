/*
 * @Author: Re_Vive
 * @LastEditTime: 2022-04-22 16:08:42
...
const TabBar: FC<ITabBar> = ({ items, textColor = '#9496a3', selColor = '#000000', bgColor = 'white', midBulge = false }) => {
	const custom = useSystem()

	const { tabIdx, sTabIdx } = usePageState()
	...
	return useMemo(() => {
		return (
			<View
				...
				style={{ backgroundColor: bgColor, boxShadow: '0 -5rpx 10rpx rgba(185,185,185,0.5)', marginBottom: custom.isPhoneX ? '40rpx' : 0 }}
			>
				{midBulge && (
					<Image
